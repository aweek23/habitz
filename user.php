...
if (!$isAdmin) {
    ...
    echo '<p style="font-family:Arial,sans-serif; margin:2rem;">Accès réservé aux administrateurs. Connectez-vous avec un compte "admin" pour ouvrir la gestion des utilisateurs.</p>';
    echo '</body></html>';
    exit;
}
...
<div class="cards-grid">
  <div class="widget-card">
    ...
    <form method="get" action="user.php" class="auth-form" style="gap: 10px;">
